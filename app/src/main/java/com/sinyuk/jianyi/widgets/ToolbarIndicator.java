...
public class ToolbarIndicator extends LinearLayout implements OnPageChangeListener {
    ...
    private int mIndicatorBackground = R.drawable.toolbar_indicator_circle;
    private int mIndicatorUnselectedBackground = R.drawable.toolbar_indicator_circle;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mIndicatorBackground = typedArray.getResourceId(R.styleable.ToolbarIndicator_ti_drawable,
                    R.drawable.toolbar_indicator_circle);
